import svgPaths from "./svg-q8ngzd7xen";
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col items-end justify-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Font_Awesome_6_Pro:Solid',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#42d6aa] text-[20px] text-center whitespace-nowrap">
        <p className="leading-[16px]">square-check</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-end justify-center py-[5px] relative shrink-0 w-[51px]">
      <Container6 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0 w-full">
      <Frame />
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] min-w-px relative text-[#192025] text-[14px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        <p className="leading-[22.86px]">Entry level - Pixel Explore</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0 w-full">
      <Frame1 />
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] min-w-px relative text-[#192025] text-[14px]" style={{ fontVariationSettings: '"opsz" 14' }}>
        <p className="leading-[22.86px]">Mid level - Pixel Pioneer</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#202020] flex-[146_0_0] h-[44px] min-w-px relative rounded-[10px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <p className="[word-break:break-word] font-['DM_Sans:SemiBold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[14px] text-center text-white w-[73px]" style={{ fontVariationSettings: '"opsz" 14' }}>
          Add
        </p>
      </div>
    </div>
...
function Container() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[8px] items-start p-[13px] relative rounded-[10px] shrink-0 w-[327px]" data-name="Container">
...
export default function ContainerMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative size-full" data-name="Container (margin)">
      <Container />
    </div>
  );
}